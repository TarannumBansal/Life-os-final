...
import { ScheduleLogEditor } from "@/src/components/ScheduleLogEditor";
...
export default function Settings() {
  ...
  const resetAll = () => update((st) => resetExecution(st));
      ...
      <ScrollView contentContainerStyle={{ padding: s.lg, paddingBottom: 40 }}>
        ...
        <Section title="DATA" c={c}>
          <Pressable testID="reset-all" onPress={resetAll} style={[styles.dangerBtn, { borderColor: c.border }]}>
            ...
            <Text style={{ color: c.error, fontWeight: "600", marginLeft: 8 }}>Reset execution — start fresh (keeps curriculum, schedule & pantry)</Text>
          </Pressable>
        </Section>
      </ScrollView>
    </View>
